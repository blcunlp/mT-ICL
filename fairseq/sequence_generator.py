...
class EnsembleModel(torch.nn.Module):
    ...
    def forward_encoder(self, encoder_input):
        if not self.has_encoder():
            return None
        img_embed = [model.img_encoder(encoder_input['image'], flag='orig') for model in self.models]
        return [model.encoder(encoder_input['src_tokens'], encoder_input['src_lengths'], img_features=img_embed[i]) for i,model in enumerate(self.models)]
